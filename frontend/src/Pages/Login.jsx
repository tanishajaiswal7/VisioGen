  ...
  return (
    <section className="max-w-md mx-auto mt-20 p-0">
      <div className="bg-gray-900 rounded-2xl shadow-2xl px-8 py-10 border-2 border-transparent transition-all duration-300 hover:border-blue-500 hover:shadow-blue-500/40" style={{ boxShadow: '0 8px 32px 0 rgba(100,105,255,0.25)' }}>
        <h2 className="text-3xl font-extrabold mb-6 text-[#fbfdf6] text-center tracking-wide">Login</h2>
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button type="submit" className="bg-blue-500 hover:bg-blue-600 transition-all duration-200 text-white py-2.5 rounded-lg font-bold shadow-md mt-2">Login</button>
          <button type="button" className="text-[#fbfdf6] underline font-semibold transition-colors duration-200 hover:text-blue-400" onClick={() => navigate("/register")}>Don't have an account? Register</button>
        </form>
      </div>
    </section>
  );
